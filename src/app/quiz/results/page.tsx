...
export default function QuizResultsPage() {
    ...
    return (
      <div className="min-h-screen bg-[#1a2744] flex items-center justify-center">
        <div className="text-center px-4">
          ...
          <h2 className="font-display font-bold text-white text-2xl mb-2">No results found</h2>
          <p className="text-white/50 mb-6 text-sm">
            It looks like you navigated here directly. Take the quiz to see your results.
          </p>
          <Link
            href="/quiz"
            className="inline-flex items-center gap-2 bg-[#c8922a] hover:bg-[#e0a83c] text-white font-semibold px-6 py-3 rounded-lg transition-colors"
          >
            Take the Quiz
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#1a2744]">
      {/* Header */}
      <div className="relative overflow-hidden bg-[#253560] border-b border-white/10">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 text-center">
          <div className="inline-flex items-center gap-2 bg-[#c8922a]/20 border border-[#c8922a]/40 rounded-full px-4 py-1.5 mb-4">
            <svg className="w-4 h-4 text-[#c8922a]" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
            </svg>
            <span className="text-[#c8922a] text-sm font-medium">Your Results Are Ready</span>
          </div>

          <h1 className="font-display font-extrabold text-white text-3xl sm:text-4xl lg:text-5xl leading-tight mb-4">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="relative rounded-2xl overflow-hidden">
            <div className={`absolute inset-0 bg-gradient-to-br ${primaryGradient} opacity-40`}/>
            <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6">
              <div className="text-[#c8922a] text-xs font-semibold uppercase tracking-widest mb-2">
                Primary Architectural Style
              </div>
              <div className="font-display font-extrabold text-white text-3xl">
                {results.primaryArch.name}
              </div>
              <div className="text-white/40 text-xs mt-1 font-mono">{results.primaryArch.code}</div>
            </div>
          </div>

          <div className="relative rounded-2xl overflow-hidden">
            <div className={`absolute inset-0 bg-gradient-to-br ${secondaryGradient} opacity-30`}/>
            <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6">
              ...
              <div className="text-white/40 text-xs mt-1 font-mono">{results.secondaryArch.code}</div>
            </div>
          </div>
        </div>
        ...
        {/* Interior Finish */}
        <div className="relative rounded-2xl overflow-hidden">
          <div className={`absolute inset-0 bg-gradient-to-br ${finishGradient} opacity-20`}/>
          <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6">
            <div className="text-[#c8922a] text-xs font-semibold uppercase tracking-widest mb-2">
              Interior Finish Direction
            </div>
            <div className="font-display font-bold text-white text-2xl sm:text-3xl">
              {results.primaryFinish.name}
              {results.secondaryFinish.name && (
                <span className="text-white/40 font-normal"> with {results.secondaryFinish.name} accents</span>
              )}
            </div>
          </div>
        </div>
        ...
        {/* Style Blend */}
        <div className="bg-[#c8922a] rounded-2xl p-6 sm:p-8">
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8">
          <div className="text-[#c8922a] text-xs font-semibold uppercase tracking-widest mb-3">
            What This Means
          </div>
          ...
          <p className="text-white/50 text-sm leading-relaxed mt-4">
            This tells us your home should feel <strong className="text-white/70">intentionally designed, not copied from a generic plan.</strong> Our team will prepare a personalized discovery presentation using this direction as the foundation.
          </p>
        </div>

        {/* Next step */}
        <div className="bg-[#253560] border border-white/10 rounded-2xl p-6 sm:p-8 text-center">
          <div className="text-4xl mb-4">📋</div>
          <h3 className="font-display font-bold text-white text-2xl mb-2">What Happens Next</h3>
