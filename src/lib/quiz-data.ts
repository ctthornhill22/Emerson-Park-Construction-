...
export const STAGE_2_QUESTIONS: StageQuestion[] = [
  ...
  // 6 options — matches the 6 floor images in moodboards/details-finishes/
  {
    id: "q2_flooring",
  ...
  // 6 options — matches the 6 cabinet images in moodboards/kitchens/
  {
    id: "q3_cabinet_style",
    ...
    options: [
      ...
      },
      {
        ...
        imageFolder: "moodboards/kitchens",
        imageName: "cabinet-slim-shaker",
        tags: ["WN", "CL"],
      },
      {
        id: "classic_shaker",
        label: "Classic Shaker",
        description: "Timeless, familiar, approachable quality",
        imageFolder: "moodboards/kitchens",
        imageName: "cabinet-classic-shaker",
        tags: ["CE", "CTG"],
      },
      {
        id: "inset_cabinetry",
  ...
  // 6 options — matches the 6 color images in moodboards/kitchens/
  {
    id: "q4_cabinet_color",
    ...
    options: [
      {
        id: "white_oak_tone",
        label: "White Oak / Natural Wood",
        description: "Warm, organic, biophilic warmth",
        imageFolder: "moodboards/kitchens",
        imageName: "color-white-oak",
        tags: ["WN", "MT"],
      },
      {
        id: "soft_white",
        label: "Soft White / Off-White",
        description: "Clean, crisp, bright and timeless",
        imageFolder: "moodboards/kitchens",
        imageName: "color-soft-white",
        tags: ["MCL", "CL", "CTG"],
      },
      {
        id: "warm_greige",
      ...
      },
      {
        ...
        imageFolder: "moodboards/kitchens",
        imageName: "color-charcoal",
        tags: ["MCL", "RI"],
      },
      {
        id: "walnut_dark_wood",
        label: "Walnut / Dark Wood",
        description: "Rich, grounded, warm depth",
        imageFolder: "moodboards/kitchens",
        imageName: "color-walnut",
        tags: ["WN", "RI"],
      },
      {
        id: "sage_soft_green",
  ...
  // 6 options — matches the 6 surface images in moodboards/kitchens/
  {
    ...
    options: [
      {
        id: "white_quartz_slab",
        label: "Clean White Quartz",
        description: "Crisp, clean, versatile and bright",
        imageFolder: "moodboards/kitchens",
        imageName: "surface-white-quartz-slab",
        tags: ["MCL", "CL"],
      },
      {
        id: "marble_zellige",
        label: "Marble + Zellige Tile",
        description: "Timeless stone with artisan tile backsplash",
        imageFolder: "moodboards/kitchens",
        imageName: "surface-marble-zellige",
        tags: ["CE", "WN"],
      },
      {
        id: "honed_neutral",
        label: "Honed Stone / Neutral Tile",
        description: "Organic, spa-inspired, calm luxury",
        imageFolder: "moodboards/kitchens",
        imageName: "surface-honed-neutral",
        tags: ["OS", "MT"],
      },
      {
        id: "dramatic_veined_slab",
        label: "Dramatic Veined Slab",
        description: "Statement centerpiece, bold luxury",
        imageFolder: "moodboards/kitchens",
        imageName: "surface-veined-slab",
        tags: ["CE", "MCL"],
      },
      {
        id: "butcher_subway",
        label: "Butcher Block + Subway Tile",
        description: "Warm, casual, cottage character",
        imageFolder: "moodboards/kitchens",
        imageName: "surface-butcher-subway",
        tags: ["CTG", "WN"],
      },
      {
        id: "dark_dramatic",
        label: "Dark & Dramatic",
        description: "Deep countertops, moody backsplash",
        imageFolder: "moodboards/kitchens",
        imageName: "surface-dark-dramatic",
        tags: ["RI", "CE"],
      },
    ],
  },
  ...
  // 6 options — matches the 6 bath images in moodboards/primary-bathrooms/
  {
  ...
  // Each option pulls a named window image from the matching style's exterior folder.
  {
    id: "q7_windows_doors",
    ...
    options: [
      ...
      {
        id: "divided_lite",
        label: "Divided Lite / Traditional",
      ...
      {
        id: "clerestory",
        label: "Clerestory / High Windows",
        description: "Natural light, privacy, organic calm",
        imageFolder: "styles/organic-modern/exterior",
        imageName: "window-clerestory",
        tags: ["OS", "MCL"],
      },
  ...
  // ── Q8: Ceiling & Volume (single, weight: 1) ────────────────────────────────
  {
    ...
    options: [
      ...
      {
        id: "dramatic_vault",
        label: "Dramatic Vault or Shed Ceiling",
        description: "Exposed structure, bold architectural moment",
        imageFolder: "moodboards/primary-bedrooms",
        imageName: "rustic-industrial-01",
        tags: ["RI", "WN"],
      },
  ...
  // 6 options — matches the 6 finish images in moodboards/details-finishes/
  {
    ...
    options: [
      {
        ...
        imageFolder: "moodboards/details-finishes",
        imageName: "finish-matte-black",
        tags: ["MCL", "RI"],
      },
      {
        id: "brushed_brass",
        label: "Brushed Brass / Satin Gold",
        description: "Warm, elevated, modern luxury",
        imageFolder: "moodboards/details-finishes",
        imageName: "finish-brushed-brass",
        tags: ["CE", "WN"],
      },
      {
        id: "polished_nickel",
        label: "Polished Nickel / Chrome",
        description: "Clean, contemporary, versatile",
        imageFolder: "moodboards/details-finishes",
        imageName: "finish-polished-nickel",
        tags: ["MCL", "CL"],
      },
      {
        id: "oil_bronze",
        ...
        imageFolder: "moodboards/details-finishes",
        imageName: "finish-oil-bronze",
        tags: ["CE", "CTG"],
      },
      {
        id: "gunmetal",
        label: "Gunmetal / Dark Nickel",
        description: "Subtle, moody, industrial-modern",
        imageFolder: "moodboards/details-finishes",
        imageName: "finish-gunmetal",
        tags: ["RI", "MCL"],
      },
      {
        id: "mixed_metals",
        label: "Mixed Metals",
        description: "Layered, collected, design-forward",
        imageFolder: "moodboards/details-finishes",
        imageName: "finish-mixed-metals",
        tags: ["WN", "OS"],
      },
    ],
  },
